...
function DesktopAppUpdateRow() {
  ...
  const isUpdateAvailable = availableUpdate?.hasUpdate === true;
  const readyUpdateVersion = availableUpdate?.readyToInstall
      ...
      <View style={[settingsStyles.row, settingsStyles.rowBorder]}>
        ...
        <View style={styles.aboutUpdateActions}>
          ...
          <Button
            ...
            disabled={isChecking || isInstalling || !isUpdateAvailable}
          >

...
export const ko: TranslationResources = {
  ...
  statusFooter: {
    ...
    hostsOnline: "온라인 호스트 {{online}}/{{total}}",
    context: "컨텍스트 {{percentage}}%",
  ...
  sidebar: {
    ...
    project: {
      actions: {
        menu: "프로젝트 작업",
        showDone: "완료된 워크스페이스 {{count}}개 표시",
        hideDone: "완료된 워크스페이스 숨기기",
        markAllDone: "모든 워크스페이스를 완료로 표시",
        archiveAllWorkspaces: "모든 워크스페이스 보관",
    ...
    workspaces: {
      showDone: "완료 {{count}}개 · 표시",
      archiveAllDone: "완료 모두 보관 ({{count}})",
      doneMenu: "완료된 워크스페이스 작업",
      hideDone: "완료 {{count}}개 · 숨기기",
    },
    liveNow: {
      title: "지금 활동 중",
      empty: "실행 중인 에이전트 없음",

...
/**
 * Durable, monotonic usage ledger across an agent's whole lifetime. Token
 * fields track the running maximum a (cumulative) provider reported; runningMs
 * accumulates wall-clock time turns were active.
 */
